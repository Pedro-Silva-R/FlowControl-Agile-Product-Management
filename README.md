# 🚀 FlowControl: Rediseño Ágil de Viáticos Corporativos

**FlowControl** es la conceptualización y gestión ágil de una Web App móvil diseñada para centralizar, digitalizar y agilizar el proceso de rendición de gastos corporativos para la empresa de transporte *TechLogistics S.A.*

* **Mi Rol:** Product Owner / Analista Funcional
...
## 🛠️ La Solución y Metodología (Acción)
...
* **Herramientas de Gestión:** Jira, Confluence.
* **Diseño y Prototipado:** Figma.
* **Técnicas de PO:** Story Mapping, Criterios de Aceptación, User Stories (INVEST).

---
*Este proyecto fue desarrollado como Caso de Estudio Integral, demostrando mi capacidad para alinear el desarrollo de software con los objetivos de negocio reales.*
